...
class SAttention(nn.Module):
    def __init__(self, d_model, nhead, dropout):
        ...
        self.qtrans = nn.LSTM(d_model, d_model // 2, num_layers=1, batch_first=True, bidirectional=True)
        self.ktrans = nn.LSTM(d_model, d_model // 2, num_layers=1, batch_first=True, bidirectional=True)
        self.vtrans = nn.LSTM(d_model, d_model // 2, num_layers=1, batch_first=True, bidirectional=True)
...
class MASTER(nn.Module):
    def __init__(self, d_feat=158, d_model=256, t_nhead=4, s_nhead=2, T_dropout_rate=0.5, S_dropout_rate=0.5,
        ...
        self.bilstm = nn.LSTM(d_feat, d_model // 2, num_layers=1, batch_first=True, bidirectional=True)
